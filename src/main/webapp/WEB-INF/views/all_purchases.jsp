    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <div class="form_settings">
            <p style="padding-top: 15px"><span>&nbsp;</span><button class = "submit" onclick="window.location.href = '/purchases/new';">Add Purchase</button></p>
        </div>
        <h1>All Purchases</h1>
        <table style="width:100%; border-spacing:0;">
            ...
            <c:forEach varStatus = "i" var="pur" items="${purchases}">
                <tr>
                    <td><a href= "/books/${pur.getBookId()}">${pur.getBookId()}</a></td>
                    <td>${pur.getBillNumber()}</td>
                    <td>${pur.getCost()}/-</td>
                    <td>${pur.getPurchaseYear()}</td>
                    <td><a href="/suppliers/${pur.getSupplierId()}">${pur.getSupplierId()}</a></td>
                </tr>
            </c:forEach>
        </table>
      </div>
