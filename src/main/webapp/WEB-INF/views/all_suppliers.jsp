    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <div class="form_settings">
            <p style="padding-top: 15px"><span>&nbsp;</span><button class = "submit" onclick="window.location.href = '/suppliers/new';">Add Supplier</button></p>
        </div>
        <h1>All Suppliers</h1>
        <table style="width:100%; border-spacing:0;">
            ...
            <c:forEach varStatus = "i" var="sup" items="${suppliers}">
                <tr>
                    ...
                    <td><a href="/suppliers/${sup.getSupplierId()}">${sup.getSupplierName()}</a></td>
                    <td>${sup.getShopName()}</td>
                    <td>${sup.getShopLocation()},${sup.getShopCity()}</td>
