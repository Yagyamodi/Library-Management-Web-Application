  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <form:form action="/purchases/new" method="POST" modelAttribute="purchase">
          <div class="form_settings">
            <p><span>BookId</span><form:select path="BookId">
                <c:forEach varStatus = "i" var="book" items="${books}">
                     <c:choose >
                       <c:when test="${purchase.getBookId()==book.getBookId()}">
                           <option value="${book.getBookId()}" selected>${book.getBookId()}</option>
                       </c:when>
                       <c:otherwise>
